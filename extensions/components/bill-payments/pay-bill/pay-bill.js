define([
    ...
    "jquery",
    "./model",
    "ojL10n!extensions/resources/nls/register-biller",
    ...
    "ojs/ojvalidationgroup"
], function (oj, ko, $, PayBillModel, locale, billerLabels, PayBillJSON, billerConfiguration) {
    "use strict";
    ...
    const vm = function (params) {
        ...
        self.relationshipDetails = self.relationshipDetails ? self.relationshipDetails : ko.observableArray();
        ...
        PayBillModel.listProductPlans(self.billerDetails.name ? self.billerDetails.name : self.billerDetails.billerNickName).done(function (data) {
            self.planArray.removeAll();
        ...
        self.createPayload = function () {
            ...
            for (let i = 0; i < billerConfiguration.length; i++) {
                ...
                if (billerConfiguration[i].BillerCode === self.billerDetails.name) {
                    ...
                    self.enquiryData().billerCode = self.billerPaymentDetails.billerName();

                    if (billerConfiguration[i].planMapping !== undefined) {

                        const item = {
                            label: billerConfiguration[i].planMapping.value,
                            value: self.billerPaymentDetails.planId()
                        };
        ...
        self.doEnquiry = function () {
            ...
            self.transactionAmount(self.billerPaymentDetails.billAmount.amount);
            ...
            if (self.enquiryRequired()) {
                ...
                PayBillModel.doEnquiry(ko.toJSON(self.enquiryData())).done(function (data) {
                    ...
                    if (data.billerPayment.errorCode === "00") {
                        const parameters = {
                            ...
                            enquiryData: self.enquiryData(),
                            transactionAmount: self.transactionAmount(),
                            confirmScreenFields: self.confirmScreenFields()
                        };
