define([
...
], function (oj, ko, $, ReviewBillPaymentModel, resourceBundle, billerLabels) {
  "use strict";
  ...
  return function (params) {
    ...
    if (params.rootModel && params.rootModel.params && params.rootModel.params.enquiryData) {
      self.confirmData(params.rootModel.params.enquiryData);
      self.confirmData().transactionAmount = params.rootModel.params.transactionAmount;
      self.confirmScreenFields(params.rootModel.params.confirmScreenFields);
    ...
    self.confirm = function () {
      ...
      ReviewBillPaymentModel.billPayment(ko.mapping.toJSON(self.billerPaymentDetails)).done(function (data, status, jqXhr) {
        ...
        ReviewBillPaymentModel.doConfirm(ko.toJSON(self.confirmData())).done(function (data) {
            ...
            if (data.billerPayment.errorCode === "00") {
              ...
              for (let i = 0; i < self.confirmScreenFields().length; i++) {
                ...
                if(self.confirmScreenFields()[i].name === "partnerRefNo"){
                  ...
                  const partnerRefNo = {
                    label: self.billerLabelsResource[self.confirmScreenFields()[i].name] || self.confirmScreenFields()[i].name,
