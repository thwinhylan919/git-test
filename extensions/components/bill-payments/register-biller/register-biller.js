...
], function (oj, ko, $, RegisterBillerModel, locale, billerLabels) {
    "use strict";
        ...
        self.save = function () {
            ...
            if (tracker.valid === "valid") {
                RegisterBillerModel.fetchNicknames().done(function (response) {
                    ...
                    if (self.registerBillerDetails.billerType() === "RECHARGE") {
                        self.registerBillerDetails.customerName("CustomerName");
                    }
