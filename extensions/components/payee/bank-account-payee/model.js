define([
  ...
  const addPayeeModel = function() {
    ...
    let getPayeeNameDeferred;
    const getPayeeName = function(accountNumber, deferred) {
      const options = {
        url: "internalPayee/payeeName?accountNumber={accountNumber}",
        version:"cz/v1",
        showMessage:false,
        success: function(data) {
          deferred.resolve(data);
    ...
    return {
      ...
      getPayeeName: function(accountNumber) {
        getPayeeNameDeferred = $.Deferred();
        getPayeeName(accountNumber,getPayeeNameDeferred);

        return getPayeeNameDeferred;
      },
