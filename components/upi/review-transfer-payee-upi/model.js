/**
 * Model for review-transfer-payee-upi
 *
 * @param {object} BaseService instance
 * @param {object} $ instance
 * @return {object} reviewTransferPayeeUpiModel
 */
define([
    "baseService", "jquery"
    ...
    const reviewTransferPayeeUpiModel = function() {
    ...
    return new reviewTransferPayeeUpiModel();
});