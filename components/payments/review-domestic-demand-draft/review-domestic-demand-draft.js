define([
    ...
    return function(rootParams) {
        ...
        function populateConfirmScreenDetails(data, addresses) {
            confirmScreenDetailsArray = [
                ...
                [{
                    ...
                    value: self.mode() === "OTHADD" ? [addresses.line1, addresses.line2, addresses.state, addresses.city, addresses.postalCode] : [
        ...
        draftModel.getDraftData(self.paymentId, "drafts", "domestic", self.transferNow()).then(function(data) {
        ...
        function callbackFunction(data) {
            ...
            rootParams.dashboard.loadComponent("confirm-screen", {
                ...
                confirmScreenExtensions: {
                    successMessage: self.getConfirmScreenMsg(data),
        ...
        self.confirmDDIssue = function() {
            ...
            if (self.params.demandDraftPayload.valueDate === null) {
                draftModel.confirmDomesticDDIssue(self.paymentId).then(callbackFunction);

            } else {
                draftModel.confirmDomesticDDInstructionIssue(self.paymentId).then(callbackFunction);
            }
        };
