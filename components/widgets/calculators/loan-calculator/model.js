define(["baseService", "jquery"], function (BaseService, $) {
   ...
   */
  const LoanCalculatorModel = function () {
    /**
    ...
    const calculateLoanAmount = function (dataToBeSent, deferred) {
        const options = {
      ...
      fetchLocalCurrency = function (deferred) {
        const options = {
          ...
          mockedUrl: "framework/json/design-dashboard/calculators/loan-calculator.json",
          success: function (data) {
            deferred.resolve(data);
          },
          error: function (data) {
