define(["baseService", "jquery"], function(BaseService, $) {
   ...
   */
  const ReviewCreateLimitModel = function() {
    /**
     ...
     */
    let createLimitDeffered;
    const createLimit = function(deferred, payload) {
      const options = {
        data: payload,
        url: "financialLimits",
    ...
    return {
      createLimit: function(payload) {
        createLimitDeffered = $.Deferred();
        createLimit(createLimitDeffered, payload);

        return createLimitDeffered;
      }
    };
  };

  return new ReviewCreateLimitModel();
});