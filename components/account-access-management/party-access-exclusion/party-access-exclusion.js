define([
  ...
  return function viewModel(rootParams) {
    ...
    self.isCorpAdmin = self.isCorpAdmin();
    ...
    if (self.isLMAllowed() === undefined) {
      self.isLMAllowed(false);
    } else {
      self.isLMAllowed(self.isLMAllowed());
    }

    if (self.isVirtualAllowed() === undefined) {
      self.isVirtualAllowed(false);
    } else {
      self.isVirtualAllowed(self.isVirtualAllowed());
    }

    if (self.isVAMEnabledRealAllowed() === undefined) {
      self.isVAMEnabledRealAllowed(false);
    } else {
      self.isVAMEnabledRealAllowed(self.isVAMEnabledRealAllowed());
    }
    ...
    self.indexSelected = ko.observable(self.indexSelected());
    ...
    self.transactionName = ko.observable(self.nls.headers.partyAcctSetupTransactionName);
    ...
    self.getLMPayload = function () {
      ...
      if (self.isLMAllowed() === true) {
        ...
        ko.utils.arrayForEach(self.fullLMAccountList(), function (item) {
          if (self.nonSelectedLMAccounts().length > 0 && self.nonSelectedLMAccounts().indexOf(item.accountNumber.value) !== -1) {
    ...
    self.getVERPayload = function () {
      ...
      if (self.isVAMEnabledRealAllowed() === true) {
        ...
        ko.utils.arrayForEach(self.fullVAMEnabledRealAccountList(), function (item) {
          if (self.nonSelectedVERAccounts().length > 0 && self.nonSelectedVERAccounts().indexOf(item.accountNumber.value) !== -1) {
    ...
    self.getVRAPayload = function () {
      ...
      if (self.isVirtualAllowed() === true) {
        ...
        ko.utils.arrayForEach(self.fullVirtualAccountList(), function (item) {
          if (self.nonSelectedVRAAccounts().length > 0 && self.nonSelectedVRAAccounts().indexOf(item.accountNumber.value) !== -1) {
    ...
    self.createAccess = function (selectedAccountsResources) {
      ...
      self.fulltdAccountList(self.fullPartiesTDAccountList()[self.indexSelected()]);
      self.fullloanAccountList(self.fullPartiesLoanAccountList()[self.indexSelected()]);
      self.fullLMAccountList(self.fullLMAccountList()[self.indexSelected()]);
      self.fullVirtualAccountList(self.fullVirtualAccountList()[self.indexSelected()]);
      self.fullVAMEnabledRealAccountList(self.fullVAMEnabledRealAccountList()[self.indexSelected()]);
      ...
      self.finalPayload.partyAccountAccessDTOs = self.finalPayLoadArray();

      ExclusionModel.createAccessClone(ko.toJSON(self.finalPayload), self.party.value(), self.isCorpAdmin).then(function (data) {
    ...
    self.updateAccess = function (selectedAccountsResources) {
      ...
      ExclusionModel.updateAccessClone(ko.toJSON(self.finalPayload), self.party.value(), self.isCorpAdmin).then(function (data) {
    ...
    self.readAccess = function () {
      ...
      ExclusionModel.readAccess(self.party.value(), self.isCorpAdmin).then(function (data) {
        self.showModuleToMap(true);

        if (data.partyAccountAccessDTOs !== undefined) {
          for (let i = 0; i < data.partyAccountAccessDTOs.length; i++) {
            if (data.partyAccountAccessDTOs[i].accountType === "CSA") {
              self.isCasaAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.casaAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedCASAExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
            ...
            } else if (data.partyAccountAccessDTOs[i].accountType === "TRD") {
              self.isTDAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.tdAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedTDExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
            ...
            } else if (data.partyAccountAccessDTOs[i].accountType === "LON") {
              self.isLoanAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.loanAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedLOANExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
            ...
            }else if (data.partyAccountAccessDTOs[i].accountType === "LER") {
              self.isLMAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.lmAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedLMExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
            ...
            else if (data.partyAccountAccessDTOs[i].accountType === "VER") {
              self.isVAMEnabledRealAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.vamEnabledRealAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedVAMEnabledRealExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
            ...
            else if (data.partyAccountAccessDTOs[i].accountType === "VRA") {
              self.isVirtualAllowed(data.partyAccountAccessDTOs[i].accessStatus);
              self.virtualAccountAccessId(data.partyAccountAccessDTOs[i].accountAccessId);
              self.updatedVirtualExclusionNumberList(data.partyAccountAccessDTOs[i].accountExclusionDTOs);
    ...
    self.deleteAccess = function () {
      ...
      ExclusionModel.deleteAccess(ko.toJSON(self.finalPayload), self.party.value()).then(function (data) {
        self.showDeleteButton(true);
        self.transactionStatus(data);
        self.showConfirmationForCreate(true);
