define([
...
], function(oj, ko, $, reviewLinkedPartyAccountAccessModel, resourceBundle) {
    "use strict";
    ...
    return function(rootParams) {
        ...
        self.rootParams = rootParams.rootModel.params ? ko.mapping.fromJS(rootParams.rootModel.params.data) : null;
        ...
        if (self.rootParams && self.rootParams.linkedPartyAccountAccessDTOs) {
            ...
            if (self.rootParams.linkedPartyAccountAccessDTOs()[0].userId) {
                self.parentAccessLevel("USER");
                self.selectedUserId = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].userId());
                self.selectedUserName = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].userId());
            } else {
                self.parentAccessLevel("PARTY");
            }

            self.partyID = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].partyId.value());
            self.party = self.rootParams.linkedPartyAccountAccessDTOs()[0].partyId;
            self.relatedPartyId = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].linkedPartyId);
            ...
            self.accessLevel = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].accessLevel());
            self.accessStatus = ko.observable(self.rootParams.linkedPartyAccountAccessDTOs()[0].accessStatus());
            ...
            for (let z = 0; z < self.rootParams.linkedPartyAccountAccessDTOs().length; z++) {
                if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accountType() === "CSA") {
                    if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accessStatus() === true) {
                ...
                if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accountType() === "TRD") {
                    if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accessStatus() === true) {
                ...
                if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accountType() === "LON") {
                    if (self.rootParams.linkedPartyAccountAccessDTOs()[z].accessStatus() === true) {
        ...
        self.populateSelectedAccounts = function() {
            ...
            if (self.rootParams && self.rootParams.linkedPartyAccountAccessDTOs) {
                if (self.rootParams.linkedPartyAccountAccessDTOs().length > 0) {
                    for (let x = 0; x < self.rootParams.linkedPartyAccountAccessDTOs().length; x++) {
                        if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountExclusionDTOs()) {
                            if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountType() === "CSA") {
                                self.isCasaAllowed(self.rootParams.linkedPartyAccountAccessDTOs()[x].accessStatus());

                                if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId) {
                                    self.casaAccountAccessId(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId());
                                }

                                self.updatedCASAExclusionNumberList(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountExclusionDTOs());
                            ...
                            } else if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountType() === "TRD") {
                                self.isTDAllowed(self.rootParams.linkedPartyAccountAccessDTOs()[x].accessStatus());

                                if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId) {
                                    self.tdAccountAccessId(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId());
                                }

                                self.updatedTDExclusionNumberList(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountExclusionDTOs());
                            ...
                            } else if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountType() === "LON") {
                                self.isLoanAllowed(self.rootParams.linkedPartyAccountAccessDTOs()[x].accessStatus());

                                if (self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId) {
                                    self.loanAccountAccessId(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountAccessId());
                                }

                                self.updatedLOANExclusionNumberList(self.rootParams.linkedPartyAccountAccessDTOs()[x].accountExclusionDTOs());
                    ...
                    self.createBaseForDataSource(self.rootParams.linkedPartyAccountAccessDTOs());
                }
            }
        };
        ...
        self.getAllAccountsCount = function() {
            ...
            reviewLinkedPartyAccountAccessModel.readAllAccountDetails(self.partyID(), self.selectedUserId()).done(function(data) {
        ...
        self.createDataSource = function() {
            ...
            if (self.fullCasaAccountListSorted().length === 0) {
            ...
            if (self.fulltdAccountListSorted().length === 0) {
            ...
            if (self.fullloanAccountListSorted().length === 0) {
