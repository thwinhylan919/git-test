define([
    ...
    const vm = function (params) {
        ...
        function mergeObject(obj1, obj2) {
            ...
            for (element in obj2) {
                if (obj2[element] !== null && obj2[element] !== undefined) {
        ...
        self.fetchLists = function () {
            LetterOfCreditModel.fetchProduct().done(function (productData) {
                //This is added to show multiple goods if it is of specific entity type
        ...
        function validateBICCodes(actionType, modalName) {
            if (self.creditAvailableWithSelected() === "SWIFTCODE" && self.letterOfCreditDetails.availableWith() !== null && self.letterOfCreditDetails.availableWith() !== "" && self.availableWithDetails() === null) {
        ...
        if (self.mode() === "EDIT") {
            ...
            if (self.letterOfCreditDetails.validBICCode && self.letterOfCreditDetails.validBICCode()) {
            ...
            if (self.letterOfCreditDetails.goods && self.letterOfCreditDetails.goods().length > 0) {
                ...
                for (i = 0; i < self.letterOfCreditDetails.goods().length; i++) {
                    self.goodsArray.push({
                        ...
                        code: ko.observable(self.letterOfCreditDetails.goods()[i].code()? self.letterOfCreditDetails.goods()[i].code() : null),
                        description: ko.observable(self.letterOfCreditDetails.goods()[i].description()? self.letterOfCreditDetails.goods()[i].description() : null),
            ...
            if (ko.utils.unwrapObservable(self.letterOfCreditDetails.requestedConfirmationParty)) {
                self.requestedConfirmationPartyLoaded(true);

                if (ko.utils.unwrapObservable(self.letterOfCreditDetails.advisingThroughBankCode) || ko.utils.unwrapObservable(self.letterOfCreditDetails.confirmingBankCode)) {
                ...
                } else if (self.letterOfCreditDetails.requestedConfirmationParty() !== "ABK") {
