define([
  ...
  const ViewLCDetailsModel = function () {
    ...
    let fetchViewShippingguaranteeDeferred;
    const fetchViewShippingguarantee = function (id, deferred) {
      const params = {
        id: id
      },
        options = {
          url: "shippingGuarantees/{id}",
          success: function (data) {
            deferred.resolve(data);
          }
        };
    ...
    return {
      ...
      fetchViewShippingguarantee: function (id) {
        fetchViewShippingguaranteeDeferred = $.Deferred();
        fetchViewShippingguarantee(id, fetchViewShippingguaranteeDeferred);

        return fetchViewShippingguaranteeDeferred;
      }
    };
  };
