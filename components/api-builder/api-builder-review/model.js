define([
  ...
  const APIBuilderReviewModel = function () {

    const baseService = BaseService.getInstance();
    let createApiGroupServiceDeferred;
    const createApiGroupService = function (payload, bussPolicyFile, deferred) {
      const form = new FormData();

      form.append("file", bussPolicyFile);
      form.append("APIBuilderDetails", payload);
    ...
    let updateApiGroupServiceDeferred;
    const updateApiGroupService = function (payload, deferred) {
      const options = {
        url: "builder/api",
        version: "ext",
        data: payload,
    ...
    return {
      createApiGroupService: function (payload, bussPolicyFile) {
        createApiGroupServiceDeferred = $.Deferred();
        createApiGroupService(payload, bussPolicyFile, createApiGroupServiceDeferred);

        return createApiGroupServiceDeferred;
      },
      updateApiGroupService: function (payload) {
        updateApiGroupServiceDeferred = $.Deferred();
        updateApiGroupService(payload, updateApiGroupServiceDeferred);

        return updateApiGroupServiceDeferred;
      },
  ...
  return new APIBuilderReviewModel();
});