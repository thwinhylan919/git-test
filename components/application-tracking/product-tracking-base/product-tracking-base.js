define([
  ...
  return function(rootParams) {
    ...
    rootParams.baseModel.registerComponent("app-tracker-summary", "application-tracking");
    rootParams.baseModel.registerComponent("app-tracker-dashboard", "application-tracking");
    self.productTrackingComponentName("app-tracker-dashboard");
