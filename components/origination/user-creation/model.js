define([
  ...
  const UserCreationModel = function() {
    ...
    let updateSubmissionForAlertDeferred;
    const updateSubmissionForAlert = function (submissionId, deferred) {
      const params = {
        submissionId: submissionId
      }, options = {
        url: "submissions/{submissionId}?actionType=SAVE_AS_DRAFT",
        success: function (data) {
          deferred.resolve(data);
        }
      };
    ...
    return {
      ...
      updateSubmissionForAlert: function (submissionId) {
        updateSubmissionForAlertDeferred = $.Deferred();
        updateSubmissionForAlert(submissionId, updateSubmissionForAlertDeferred);

        return updateSubmissionForAlertDeferred;
      }
    };
  };
