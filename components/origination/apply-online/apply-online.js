define([
    ...
    function(ko, $, BankProductModel, resourceBundle, resourceBundleProducts) {
        ...
        return function(Params) {
            ...
            Params.dashboard.headerName(self.nls.quickLinks.labels.quickHeading);
            ...
            BankProductModel.fetchProductTiles().then(function(data) {
            ...
            self.switchPageProduct = function() {
                ...
                if (self.className() === "LOANS") {
                    ...
                    url = "productClass/CREDIT_CARD/productGroups?productType=" + self.actionCardData().productClass;
                } else {
                ...
                BankProductModel.fetchProductGroups(url).then(function(data) {
                    if (data && data.productGroups && data.productGroups[0]) {
                        ...
                        if (self.actionCardData().productClass !== "LOANS") {
                            ...
                            BankProductModel.fetchDealerList().then(function(data) {
                                if (data.listDealers.length > 0) {
                                    ...
                                    BankProductModel.createSession().then(function() {
