define([
  ...
  return function(rootParams) {
    ...
    self.initializeModel = function() {
      ...
      let identificationClass;

      if(self.productDetails().productType !== "CREDIT_CARD"){
        identificationClass = self.productDetails().productType;
      } else {
        identificationClass = self.productDetails().productType;
      }

      IdentityInfoModel.getIdentificationTypeList(identificationClass).then(function(data) {
