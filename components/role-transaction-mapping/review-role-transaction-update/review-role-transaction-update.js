define([
...
], function (oj, ko, RoleTransactionUpdateReviewModel, resourceBundle) {
    "use strict";
    ...
    return function (rootParams) {
        ...
        self.isAccessPointTabsFetched = ko.observable(false);
        ...
        if (self.approvalData) {
            ...
            self.accessType = ko.observable(self.approvalData.applicationRoleDTO.accessPointType === "INT" ? self.nls.common.menu.internal : self.nls.common.menu.external);
            self.selectedModuleName = ko.observable(self.approvalData.modules);
        ...
        self.showTabBar = function () {
            ...
            if (self.selectedAccessType() === "INT") {
                ...
                self.isAccessPointTabsFetched(true);
        ...
        if (self.approvalData && self.approvalData.accessTransactionMapDTO && self.approvalData.applicationRoleDTO && self.approvalData.modules) {
            ...
            RoleTransactionUpdateReviewModel.fetchModuleName().done(function (data) {
            ...
            self.userType = ko.observable(self.approvalData.applicationRoleDTO.enterpriseRole);
            ...
            RoleTransactionUpdateReviewModel.fetchAccess(searchParameters).done(function (data) {
        ...
        self.back = function () {
            const params = {
                ...
                isEdit: rootParams.rootModel.params.isEdit,
