define([
  ...
  const baseService = BaseService.getInstance(),
     ...
     */
    MenuModel = function() {
      let fetchAlertListDeferred;
      const fetchAlertList = function(deferred) {
        const options = {
          url: "mailbox/alerts",
          throttle: false,
      ...
      return {
        fetchAlertList: function() {
          fetchAlertListDeferred = $.Deferred();
          fetchAlertList(fetchAlertListDeferred);

          return fetchAlertListDeferred;
        },
