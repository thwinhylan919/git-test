define([
  ...
  return function(params) {
    ...
    self.confirmScreenDetails = params.rootModel.confirmScreenDetails ? params.rootModel.confirmScreenDetails: [] ;
    ...
    self.stages = [{
      ...
      },
      {
        ...
        templateName: "trade-finance/view-guarantees/bank-guarantee-terms-and-conditions"
      },
      {
