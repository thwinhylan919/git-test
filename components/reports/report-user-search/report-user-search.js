define([
    ...
    "ojs/ojcore",
    "./model",
    "ojL10n!resources/nls/report-user-search",
    "ojs/ojknockout-validation",
    "ojs/ojinputtext",
    "ojs/ojlistview",
    "ojs/ojtable",
    "ojs/ojarraytabledatasource"
], function (ko, $, oj, ReportUserSearchModel, resourceBundle) {
    "use strict";
    ...
    return function (rootParams) {
        ...
        self.Nls = resourceBundle.reportUserSearch;
        rootParams.baseModel.registerElement("row");
        rootParams.baseModel.registerElement("page-section");
        rootParams.baseModel.registerElement("confirm-screen");
        rootParams.baseModel.registerComponent("party-validate", "common");
        rootParams.baseModel.registerElement("action-header");
        rootParams.baseModel.registerComponent("report-user-map", "reports");
        rootParams.dashboard.headerName(self.Nls.reportMap);
        ...
        if (self.isAdmin() === false) {
            ReportUserSearchModel.fetchMe().done(function (partyId) {
                if (partyId.userProfile.partyId.value) {
                    ...
                    ReportUserSearchModel.fetchMeWithParty().done(function (dataName) {
        ...
        self.fetchUsers = function () {
            ReportUserSearchModel.listMappedUsers(self.partyDetails.party.value()).done(function (data) {
                self.mappedUsersList(data.mappedUsersList);
            });

            ReportUserSearchModel.listUsers(self.generateURL(self.partyDetails.party.value())).done(function (data) {
        ...
        self.generateURL = function (data) {
            ...
            return "users?userGroup=Administrator";
        };
        ...
        self.goToMap = function (data) {
            ...
            rootParams.dashboard.loadComponent("report-user-map", params);
        };
        ...
        self.onUserSelectedInTable = function (event) {
            if (event.detail.value) {
                ...
                const params = {
                    isAdmin: self.isAdmin(),
                    selectedUser: self.usersList()[event.detail.value[0].startIndex.row]
                };
