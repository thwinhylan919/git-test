define([
...
], function (oj, ko, $, BillerRegistrationModel, resourceBundle) {
  "use strict";
  ...
  return function (rootParams) {
    ...
    if (rootParams.dashboard.isDashboard() === false) {
      rootParams.dashboard.headerName(self.Nls.labels.BILLER_MAINTENANCE);
    }
    ...
    self.fetchTransactionList = function () {
      ...
      BillerRegistrationModel.getTransactionList(self.view, self.fromDate && self.fromDate(), self.toDate && self.toDate(), rootParams.dashboard.appData.segment === "ADMIN" ? "A" : rootParams.dashboard.appData.segment === "CORPADMIN" ? "PA" : "P").done(function (data) {
