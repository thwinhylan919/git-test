  ...
  const RequirementsModel = function() {
    ...
    const fetchFrequencyList = function(submissionId, data, deferred) {
      const params = {
        ...
        url: "submissions/{submissionId}/depositApplications/interestFrequencies?currency={baseCurrency}&amount={requestedAmount}&days=0&months={months}&years={years}&offerID={offerId}&productCode={productCodeTD}&productGroupSerialNumber={productGroupSerialNumber}",
        success: function(data) {
          deferred.resolve(data);
        },
        error: function(data) {
