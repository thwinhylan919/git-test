define([
  ...
  return function IncomeInfoModel() {
    ...
    let saveModelEmploymentProfileDeferred;
    /**
     ...
     * @private
     */
    const saveModelEmploymentProfile = function(model, deferred) {
      modelStateChanged = true;
    ...
    return {
      ...
      createEmploymentProfile: function(data) {
        objectInitializedCheck();
        saveModelEmploymentProfileDeferred = $.Deferred();
        saveModelEmploymentProfile(data, saveModelEmploymentProfileDeferred);

        return saveModelEmploymentProfileDeferred;
      }
    };
  };
});
