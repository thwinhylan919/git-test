define([
    "knockout",
    "./model",
  "ojL10n!lzn/beta/resources/nls/origination/property-info",
  "ojs/ojinputtext",
  "ojs/ojcheckboxset"
  ...
  return function(rootParams) {
    ...
    self.setPrimaryResidence = function(event, data) {
    ...
    self.savePropertyInfo = function() {
      ...
      PropertyInfoModel.savePropetyInfo(ko.toJSON(self.productDetails().requirements), self.productDetails().submissionId.value).done(function() {
