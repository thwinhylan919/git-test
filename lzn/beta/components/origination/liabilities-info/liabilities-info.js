define([
  ...
  return function(rootParams) {
    ...
    self.submitLiabilityInfo = function(event, data) {
      const liabilitiesInfoTracker = document.getElementById("liabilitiesInfoTracker");

      if (liabilitiesInfoTracker.valid === "valid") {
        ...
        liabilitiesInfoTracker.showMessages();
        liabilitiesInfoTracker.focusOn("@firstInvalidShown");
      }
    };
