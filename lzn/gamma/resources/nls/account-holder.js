  ...
  const accountHolderLocale = function() {
    return {
      root: {
        ...
        accoutnHolderConfigClick: "Click For Account Holder",
        accoutnHolderConfigInfoClick: "Click For Account Holder Info",
        ...
        applicationForm: "Click For application Form In account Holder",
        applicationFormInfo: "Click For application Form In account Holder Info",
        applicationCardImageInfo: "Click For application Form In account Holder Information",
        applicationCardImage: "Click application Card Image",
        messages: {
