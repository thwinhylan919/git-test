define([
  ...
  return function ContactInfoModel() {
    ...
    const Model = function() {
      this.contactInfo = {
        ...
        address: {
          ...
          accomodationType: "",
          stayingSince: "",
          temp_stayingSinceMonths: "",
          temp_stayingSinceYears: "",
          sameAsCurrent: false,
          postalAddress: {
            country: "US",
            state: "",
     ...
     * @private
     */
    const saveModel = function(deferred) {
      const params = {
          submissionId: submissionId,
          applicantId: applicantId
        },
     ...
     * @private
     */
    const deleteContact = function(contactId, deferred) {
      const params = {
          submissionId: submissionId,
          applicantId: applicantId,
          contactId: contactId
    ...
    return {
      ...
      deleteContact: function(contactId) {
        deleteContactDeferred = $.Deferred();
        deleteContact(contactId, deleteContactDeferred);

        return deleteContactDeferred;
      },
