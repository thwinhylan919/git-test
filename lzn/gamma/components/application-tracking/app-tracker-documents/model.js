  ...
  const ApplicationDocumentsService = function() {
    ...
    const fetchDocumentsByteArray = function(documentUrl, ownerId, applicationId, deferred) {
      const params = {
        ...
        options = {
          url: "contents/{documentUrl}?alt={mediaType}&ownerId={ownerId}&applicationId={applicationId}&transactionType=OR",
          success: function(data) {
            deferred.resolve(data);
          }
        };
    ...
    const getDocumentInfo = function(documentId, ownerId, applicationId, deferred) {
      const params = {
        ...
        options = {
          url: "contents/{documentId}?ownerId={ownerId}&applicationId={applicationId}&transactionType=OR",
          selfLoader: true,
          success: function(data) {
            deferred.resolve(data);
          }
    ...
    return {
      ...
      getDocumentInfo: function(documentId, ownerId, applicationId) {
        getDocumentInfoDeffered = $.Deferred();
        getDocumentInfo(documentId, ownerId, applicationId, getDocumentInfoDeffered);
