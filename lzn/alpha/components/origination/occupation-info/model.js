define([
  ...
  return function OccupationInfoModel() {
     ...
     *
     * @class Model
     * @param {string} modelData - Model Data.
     * @returns {void}
     * @private
    ...
    const Model = function(modelData) {
      this.employmentDTOs = [{
        ...
        industry: modelData ? modelData.industry : "",
        occupation: modelData ? modelData.occupation : "",
        department: modelData ? modelData.department : "",
        designation: modelData ? modelData.designation : "",
        employeeId: modelData ? modelData.employeeId : "",
        grossAnnualSalary: {
          currency: "",
          amount: modelData && modelData.grossAnnualSalary ? modelData.grossAnnualSalary.amount : ""
        },
        ...
        employerAddress: {
          country: modelData && modelData.employerAddress ? modelData.employerAddress.country : "",
          state: modelData && modelData.employerAddress ? modelData.employerAddress.state : "",
          city: modelData && modelData.employerAddress ? modelData.employerAddress.city : "",
          postalCode: modelData && modelData.employerAddress ? modelData.employerAddress.postalCode : "",
          line1: modelData && modelData.employerAddress ? modelData.employerAddress.line1 : "",
          line2: modelData && modelData.employerAddress ? modelData.employerAddress.line2 : ""
        },
    ...
    const fetchFinancialTemplate = function(deferred, empType) {
      ...
      /**
       * ValidateEmployment - fires request to validate entered employment details.
       *
       * @param  {string} submissionId   - Submission id for application.
       * @param  {string} applicantId    - Applicant id of the applicant.
       * @param  {Object} successHandler - Function to be called after successfull validation.
       * @return {Object}                Void.
       */
     ...
     * @function saveModel
     * @memberOf OccupationInfoModel
     * @param {string} model - Model for current application.
     * @param {string} deferred - Deferred Object.
     * @returns {void}
     * @private
     */
     ...
     * @memberOf OccupationInfoModel
     * @param {string} id - Id for current application.
     * @param {string} deferred - Deferred Object.
     * @returns {void}
     * @private
     */
    const deleteModel = function(id, deferred) {
      ...
      /**
       * ObjectInitializedCheck - usde to check whether variables are inialised or not.
       *
       * @return {Object}  Void.
       */
    ...
    return {
       ...
       * @function init
       * @memberOf OccupationInfoModel
       * @returns {Object} ModelInitialized Object.
       */
       ...
       * @function saveModel
       * @memberOf OccupationInfoModel
       * @param {Object} model - Data for application.
       * @returns {Object} DeferredObject.
       * @example
       */
       ...
       *
       * @param {Object} empType - EmpType for application.
       * @returns {Object} DeferredObject.
       */
