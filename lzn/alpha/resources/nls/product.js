define([
  ...
  "ojL10n!lzn/alpha/resources/nls/accordion-names"
  ...
  const productLocale = function() {
    return {
      root: {
        ...
        privacyAndSecurityPolicyTitle: "Keep your information private and secure",
        ...
        productGroupsHeader: {
          ...
          productGroupsHeaderCheckings: "Explore our Checking account products",
